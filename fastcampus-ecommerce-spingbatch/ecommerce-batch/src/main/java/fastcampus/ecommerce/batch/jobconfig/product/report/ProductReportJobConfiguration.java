...
public class ProductReportJobConfiguration {
    ...
    @Bean
    public Job productReportJob(JobRepository jobRepository, JobExecutionListener listener, TaskExecutor taskExecutor, Flow categoryReportFlow, Flow brandReportFlow, Flow manufacturerReportFlow, Flow productStatusReportFlow
    ) {
